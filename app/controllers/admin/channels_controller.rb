class Admin::ChannelsController < Admin::ApplicationController
  ...
  private
    ...
    def admin_channel_params
      params.require(:admin_channel).permit(:user_id, :theme_id, :parent_id, :typo, :title, :short_title, :properties, :default_url, :tmp_index, :tmp_list, :tmp_detail, :keywords, :description, :content)
    end
end
